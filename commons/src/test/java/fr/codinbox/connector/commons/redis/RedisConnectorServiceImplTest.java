...
class RedisConnectorServiceImplTest {

    @SystemStub
    private EnvironmentVariables env;

    private RedisConnectorServiceImpl service;

    @BeforeEach
    void setUp() {
        service = new RedisConnectorServiceImpl(Logger.getLogger("test"));
    }
    ...
    void init_missingConfig_exitOnFailure_throws() {
        env.set("CONNECTOR_REDIS_BAD_EXIT_ON_FAILURE", "true");
        env.set("CONNECTOR_REDIS_BAD_OTHER", "value");
    ...
    void init_missingConfig_noExitOnFailure_skips() throws ConnectionInitException {
        env.set("CONNECTOR_REDIS_BAD_EXIT_ON_FAILURE", "false");
        env.set("CONNECTOR_REDIS_BAD_OTHER", "value");
